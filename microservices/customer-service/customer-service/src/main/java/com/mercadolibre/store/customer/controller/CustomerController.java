package com.mercadolibre.store.customer.controller;
...
import com.mercadolibre.store.customer.service.CustomerService;
...
public class CustomerController {
    ...
    public ResponseEntity<Customer> getCustomerFallBack(long id,Throwable e) {
